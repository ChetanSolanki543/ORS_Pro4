...
@WebServlet(name = "PriscriptionListCtl", urlPatterns = { "/ctl/PriscriptionListCtl" })

public class PriscriptionListCtl extends BaseCtl {
	@Override
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		if (OP_SEARCH.equalsIgnoreCase(op)) {
			...
			if (ids != null && ids.length > 0) {
				PriscriptionBean deletebean = new PriscriptionBean();
				for (String id : ids) {
					...
					ServletUtility.setSuccessMessage(" Priscription is Deleted Successfully", request);
				}
			} else {
	...
	protected String getView() {
		...
		return ORSView.PRISCRIPTION_LIST_VIEW;
	}
