	...
	<form action="<%=ORSView.JOB_LIST_CTL%>" method="post">
		...
		<center>
			...
			<table width="100%" align="center">
				...
				<td align="center"><label>Opening Date</font> :

				</label> <input type="text" name="Dob" id="udate"
					placeholder="Enter Joing Date"
					value="<%=ServletUtility.getParameter("Dob", request)%>">
				<td align="center"><label>Experience</font> :


				</label> <input type="text" name="Experience" placeholder="Enter Experience"
				...
				</label> <%=HTMLUtility.getList("proList", String.valueOf(bean.getStatus()), proList)%>
					&nbsp; <input type="submit" name="operation"
					value="<%=JobListCtl.OP_SEARCH%>"> &nbsp; <input
					type="submit" name="operation" value="<%=JobListCtl.OP_RESET%>"></td>
				</tr>
			</table>
