...
<body>
	...
	<form action="<%=ORSView.PRODUCT_LIST_CTL%>" method="post">
		...
		<center>
			...
			<%
				HashMap map = (HashMap) request.getAttribute("lg");
			 %>	
			...
			<table width="100%" align="center">
				<tr>
					...
					&emsp;	<td ><label>Product Amount</font> :
						...
						&emsp; &emsp; <label>Product Status</font> :
					</label> <%=HTMLUtility.getList("ProductStatus", String.valueOf(bean.getProductStatus()), map)%>
